...
function Dashboard ({ dashboard }) {
  ...
  return (
    <Row gutter={24}>
      ...
      <Col lg={12} md={24}>
        <Card title="员工值班时间统计" bordered={false} {...bodyStyle}>
          <RecentSales data={recentSales} />
        </Card>
      </Col>
      <Col lg={12} md={24}>
        <Card title="展馆游客留言" bordered={false} {...bodyStyle}>
      ...
      <Col lg={8} md={24}>
        <Card title="各个展厅参观占比" bordered={false} {...bodyStyle}>
          <Browser data={browser} />
        </Card>
      </Col>
      <Col lg={8} md={24}>
        <Card title="服务器使用情况" bordered={false} {...bodyStyle}>
          <Cpu {...cpu} />
        </Card>
      </Col>
      <Col lg={8} md={24}>
